...
export const fetchCoustomerDetails = createAsyncThunk(
  "customer/customerrDetails",
  async (mobaile, { rejectWithValue }) => {
    try {
      console.log("CoustomerDetails in Createthank", mobaile);
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `${baseUrl}/api/coustomer/coustomerDetails`,
        {
          method: "POST",
          headers: {
            Authorization: `${token}`,
...
export const fetchCoustomerDetailsByID = createAsyncThunk(
  "customer/fetchCoustomerDetailsByID",
  async (coustomerID, { rejectWithValue }) => {
    try {
      // console.log("CoustomerDetails in Createthank", coustomerID)
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `${baseUrl}/api/coustomer/getCoustomerDetailsByID/${coustomerID}`,
        {
          method: "GET",
          headers: {
            Authorization: `${token}`,
...
export const fetchFishDetails = createAsyncThunk(
  "fish/fishDetails",
  async (fishID, { rejectWithValue }) => {
    try {
      ...
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `${baseUrl}/api/fish/fishDetails/${fishID}`,
        {
          method: "GET",
          headers: {
            Authorization: `${token}`,
...
export const addCoustomer = createAsyncThunk(
  "coustomer/addCoustomer",
  async ({ formData, fishID }, { rejectWithValue }) => {
    try {
      // console.log("IN createThank", formData, fishID)
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `${baseUrl}/api/coustomer/coustomerFishBuy/${fishID}`,
        {
          method: "POST",
          headers: {
            Authorization: `${token}`,
...
export const fetchAllCoustomer = createAsyncThunk(
  "coustomer/fetchAllCoustomer",
...
export const fullPaymentByCoustomer = createAsyncThunk(
  "coustomer/fullPaymentByCoustomer",
  async ({ Payment, coustomerID }, { rejectWithValue }) => {
    try {
      console.log("IN createThank", Payment, coustomerID);
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `${baseUrl}/api/coustomer/fullPaymentByCoustomer/${coustomerID}`,
        {
          method: "POST",
          headers: {
            Authorization: `${token}`,
...
export const onePaymentByCoustomer = createAsyncThunk(
  "coustomer/onePaymentByCoustomer",
  async ({ Payment, coustomerID, transactionID }, { rejectWithValue }) => {
    try {
      ...
      const token = localStorage.getItem("authToken");
      const response = await fetch(
        `${baseUrl}/api/coustomer/onePaymentByCoustomer/${coustomerID}/${transactionID}`,
        {
          method: "POST",
          headers: {
            Authorization: `${token}`,
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchCoustomerDetailsByID.fulfilled, (state, action) => {
        console.log(
          "In fetchAllCoustomer By ID action.payload",
          action.payload
        );
